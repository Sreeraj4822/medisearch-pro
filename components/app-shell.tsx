...
const navItems = [
  ...
  { href: '/doctors', label: 'Doctors', icon: HeartPulse },
      ...
      <Sidebar>
        <SidebarHeader>
          <div className="flex items-center gap-2">
             <Button variant="ghost" size="icon" className="shrink-0 bg-primary/20 hover:bg-primary/30 text-primary" asChild>
                <Link href="/">
                    <MedicalPlusIcon className="size-5" />
                    <span className="sr-only">MediSearch Pro</span>
                </Link>
             </Button>
            <h1 className="font-headline text-lg font-semibold tracking-tight">MediSearch Pro</h1>
          </div>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
